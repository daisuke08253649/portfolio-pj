<template>
  <div class="about">
    <div class="weather">
      ...
      <a @click="$router.push({ name: 'Home' })" class="cp_btn">戻る</a>
    </div>
  </div>
</template>
...
export default {
  ...
  async created() {
    const item = await axios.get(
      `https://api.openweathermap.org/data/2.5/weather?q=${this.city}&units=metric&appid=fe99bc357b10c34acd98782807a0a2cf`
    );
